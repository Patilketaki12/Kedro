...
# my_kedro_project documentation build
...
from my_kedro_project import __version__ as release

# -- Project information -----------------------------------------------------

project = "my_kedro_project"
author = "Kedro"
...
htmlhelp_basename = "my_kedro_projectdoc"
...
latex_documents = [
    (
        master_doc,
        "my_kedro_project.tex",
        "my_kedro_project Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "my_kedro_project",
        "Project my_kedro_project codebase.",
        "Data-Science",
    )
]
